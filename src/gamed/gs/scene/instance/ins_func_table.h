#ifndef GAMED_GS_SCENE_INSTANCE_INS_FUNC_TABLE_H_
#define GAMED_GS_SCENE_INSTANCE_INS_FUNC_TABLE_H_
...
namespace insScript {
	...
	/// function table
	///
	extern luabind::CFunction ins_script_func_table[];
	extern int func_table_size;

} // namespace insScript
} // namespace gamed

#endif // GAMED_GS_SCENE_INSTANCE_INS_FUNC_TABLE_H_
