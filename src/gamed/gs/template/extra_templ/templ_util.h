#ifndef GAMED_GS_TEMPLATE_EXTRATEMPL_TEMPL_UTIL_H_
#define GAMED_GS_TEMPLATE_EXTRATEMPL_TEMPL_UTIL_H_
...
#define INIT_STAITC_EXTRATEMPLATE(class_name, type) \
	INIT_STATIC_PROTOPACKET(class_name, type)

#define DECLARE_EXTRATEMPLATE(class_name, type) \
	DECLARE_PACKET_CLONE_TEMPLATE(class_name, type, extraTempl::BaseExtraTempl, extraTempl::BaseExtraTemplManager)
...
#endif // GAMED_GS_TEMPLATE_EXTRATEMPL_TEMPL_UTIL_H_
