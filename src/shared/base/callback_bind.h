#ifndef SHARED_BASE_CALLBACK_BIND_H_
#define SHARED_BASE_CALLBACK_BIND_H_

#define UTIL_GET_CALLBACK_FACTORY_BIND_FREE(freeFuncPtr) \
    (shared::bind::GetCallbackFactory(freeFuncPtr).Bind<freeFuncPtr>())
...
#define UTIL_GET_CALLBACK_FACTORY_BIND_MEMBER(memFuncPtr, instancePtr) \
    (shared::bind::GetCallbackFactory(memFuncPtr).Bind<memFuncPtr>(instancePtr))
...
#endif // SHARED_BASE_CALLBACK_BIND_H_
